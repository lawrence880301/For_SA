...
public class Manager {
     ...
     * @param name 會員姓名
     */
    public Manager(String email, String password, String firstName, String lastName, String gender, Date Dob) {
        this.email = email;
     ...
     * @param name 管理員姓名
     */
    public Manager(int id, String email, String password, String firstName, String lastName) {
        this.id = id;
        this.email = email;
        this.password = password;
        this.firstName = firstName;
     ...
     * @param lastName 
     */
    public Manager(int id, String email, String password, String firstName, String lastName, String gender,Date Dob) {
        this.id = id;
        this.email = email;
        this.password = password;
        this.firstName = firstName;
    ...
    private void calcAccName() {
        /** 計算目前分鐘數為偶數或奇數 */
        String curr_status = (this.login_times % 2 == 0) ? "偶數管理員" : "奇數管理員";
        /** 將新的會員組別指派至Member之屬性 */
