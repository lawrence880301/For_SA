...
//    private MemberHelper mh =  MemberHelper.getHelper();
     ...
     * @param quantity 會員密碼
     */
    public JoinedRoomList( int Id_member,String Name ,Date Date ,String Type ,String Place) {
    	this.Id_member = Id_member;
//        this.Id_room = r.getID();/*待商榷*/
        this.Name = Name;
        this.Date = Date;
        this.Type = Type;
        this.Place = Place;
...
//    public JoinedRoomList(int Id_room ,String Name ,Date Date ,String Type ,String Place) {
...
//    }
    ...
    /**
     * 實例化（Instantiates）一個新的（new）OrderItem 物件<br>
     * 採用多載（overload）方法進行，此建構子用於查詢訂單細項時
     *
     ...
     * @param subtotal 小計
     */
    public JoinedRoomList(int Id_member) {
    	this.Id_member = Id_member;/*LocalStorage*/
    }
