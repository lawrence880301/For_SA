...
public class MemberHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`members` WHERE `member_id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                m = new Member(member_id, email, password, firstName, lastName, gender,  Dob);
    ...
    public JSONObject getByID(int id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`members` WHERE `member_id` = ? LIMIT 1";
    ...
    public JSONObject getByEmail(String enterEmail,String enterPwd) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM missa.members WHERE email = ? AND pwd = ? LIMIT 1";
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`members`(`firstName`,`lastName`, `email`, `pwd`,`gender` ,`Dob` )"
                    + " VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`members` SET `firstName` = ?,`lastName` = ? ,`pwd` = ?  WHERE `email` = ?";
            /** 取得所需之參數 */
            String firstName = m.getFirstName();
            String lastName = m.getLastName();
            String email = m.getEmail();
    ...
    public void updateLoginTimes(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`members` SET `login_times` = ? WHERE `member_id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
    ...
    public void updateStatus(Member m, String status) {      
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`members` SET `status` = ? WHERE `member_id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
