...
public class ManagerHelper {
    ...
    public static ManagerHelper getHelper() {
        /** Singleton檢查是否已經有ManagerMemberHelper物件，若無則new一個，若有則直接回傳 */
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`managers` WHERE `manager_id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                m = new Manager(manager_id, email, password, firstName, lastName, gender,  Dob);
    ...
    public JSONObject getByID(int id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`managers` WHERE `manager_id` = ? LIMIT 1";
    ...
    public JSONObject getByEmail(String enterEmail,String enterPwd) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`managers` WHERE `email` = ? AND `pwd` = ? LIMIT 1";
            
            /** 將參數回填至SQL指令當中 */
            pres = conn.prepareStatement(sql);
            pres.setString(1, enterEmail);
            pres.setString(2, enterPwd);
            ...
            while(rs.next()) {
                ...
                String email = rs.getString("email");
                String password = rs.getString("pwd");
                int manager_id = rs.getInt("managers_id");
                System.out.println(email);
                System.out.println(password);

            	jso.put("email",email);
            	jso.put("pwd", password);
            	jso.put("manager_id", manager_id);
            }
    ...
    public JSONObject create(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`managers`(`firstName`,`lastName`, `email`, `pwd`,`gender` ,`Dob` )"
                    + " VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`managers` SET `firstName` = ?,`lastName` = ? ,`pwd` = ?  WHERE `email` = ?";
            /** 取得所需之參數 */
            String firstName = m.getFirstName();
            String lastName = m.getLastName();
            String email = m.getEmail();
            ...
            /** 紀錄真實執行的SQL指令，並印出 **/
            exexcute_sql = pres.toString();
            System.out.println(exexcute_sql+"hello");
    ...
    public void updateLoginTimes(Manager m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`managers` SET `login_times` = ? WHERE `manager_id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
    ...
    public void updateStatus(Manager m, String status) {      
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `missa`.`managers` SET `status` = ? WHERE `manager_id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
