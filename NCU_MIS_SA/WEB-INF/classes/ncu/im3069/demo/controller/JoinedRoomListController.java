 ...
 * @since 1.0.0
 */
@WebServlet("/api/joinedroomlist.do")
public class JoinedRoomListController extends HttpServlet {
    ...
    /**
//     * 處理Http Method請求POST方法（新增資料）(移動至roomcontroller)
//     *
...
//        Date Date = null;
//		try {
//			Date = (Date)formatter.parse(jso.getString("Dob"));
...
//		try {
//			JoinedDate = (Date)formatter.parse(jso.getString("Dob"));
//		} catch (JSONException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		} catch (ParseException e) {
...
//		
//        /** 建立一個新的會員物件 */
//		JoinedRoomList jrl = new JoinedRoomList(Id,Id_member,Id_room ,Name ,Date ,Type ,Place,JoinedDate);
...
//            JSONObject data = jrlh.create(jrl,Id_member);
//            
//            
...
//        	和資料庫相關的動作都在MemberHelper裡面做
            JSONObject query = jrlh.getAll(i);
...
//            JSONObject query = jrlh.getByID(id);
//            
//            /** 新建一個JSONObject用於將回傳之資料進行封裝 */
//            JSONObject resp = new JSONObject();
//            resp.put("status", "200");
...
//        }
    ...
    public void doDelete(HttpServletRequest request, HttpServletResponse response)
        ...
        JSONObject query = jrlh.deleteByID(id);
...
//
//        /** 透過傳入之參數，新 建一個以這些參數之會員Member物件 */
//        Member m = new Member(id, email, password, firstName, lastName);
//        
